    ...
    <S.CareerWrapper>
      ...
      <S.ContentWrapper>
        <S.CompanyWrapper>
          <S.CompanyLogo>
            <S.CompanyImg
              src={process.env.PUBLIC_URL + "/assets/image/eco.png"}
            />
          </S.CompanyLogo>
          <S.CompanyCareer>
            ...
            <S.CompanyDesc>
              ...
              Framework를 경험해 보았으며, JSP 유지보수를 위해 jQuery를 활용하여
              작업을 하였습니다.
            </S.CompanyDesc>
            ...
            <S.CompanyDesc>
              <S.WorkWrapper>
                <S.WorkList>ios,iphone 본인 인증 팝업 창 오류 수정</S.WorkList>
                <S.WorkList>퍼블리싱 진행</S.WorkList>
                <S.WorkList>
                  토스페이먼츠 API를 활용한 문화강좌 송금 관리 시스템 개발
                </S.WorkList>
                <S.WorkList>Chart.js를 활용한 도서관 통계 기능 개발</S.WorkList>
                <S.WorkList>
        ...
        <S.CompanyWrapper>
          <S.CompanyLogo>
            <S.CompanyImg
              src={process.env.PUBLIC_URL + "/assets/image/tmax.jpg"}
            />
          </S.CompanyLogo>
          <S.CompanyCareer>
            ...
            <S.CompanyDesc>
              ...
              및 컴포넌트 모듈이 포함되며 SuperApp 내에서 SNS(Social Networking
              Service)를 제공하는 Cafe, FanClub 및 초개인화를 지원하는 MyApp,
              Hi-Me 를 개발하고 있습니다.
              <br />
              <br />
